...
class Model(BaseModel):
    ...
    def __init__(self, args, mesh_sampler, feature_net=None):
        ...
        if feature_net is not None:
            ...
            self.feature_net = FeatureNet2D(input_ch=self.input_ch, output_ch=self.descriptor_dim)
        ...
        self.local_densify_net = LocalDensifyNet(
            ...
            global_embedding_type='coords',
            norm=self.norm,
            local_feature_fusion='visibility_filtered_normal_weighted_mean_var_v2',
        )
