...
class Model(BaseModel):
    ...
    def __init__(self, 
        ...
        if global_feature_fusion == 'mean_var':
        ...
        from modules.grid_localizer import RigidGridLocalizer
        self.grid_refiner = RigidGridLocalizer(
            input_channels=self.fuse_ops_num*self.input_ch,
    ...
    def sample_global_features(self, feature_maps, camera_intrinsics, camera_extrinsics, camera_distortions, random_grid=False, return_features=False):
    ...
    def forward(self, feature_maps, camera_intrinsics, camera_extrinsics, camera_distortions, random_grid=True, return_features=False):
        ...
        global_net_output = self.global_net(global_feature_grid, return_features=return_features)  # (B*1, L, Dg, Dg, Dg)
        if return_features:
            global_cost_volume, features = global_net_output
        else:
            global_cost_volume = global_net_output
        ...
        output = {
            ...
            'transformed_grid_origin': transformed_grid_origin,
