...
class EncoderDecorder(nn.Module):
    ...
    def forward(self, x, verbose=False, return_features=False):
        ...
        if return_features:
            features = x.squeeze(2).squeeze(2).squeeze(2)
...
class V2VModel(nn.Module):
    ...
    def forward(self, x, return_features=False):
        ...
        if return_features:
            x, features = self.encoder_decoder(x, verbose=False, return_features=True)
        else:
            x = self.encoder_decoder(x, verbose=False)
