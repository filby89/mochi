...
class Resnet34_8s_skip2(nn.Module):
    ...
    def __init__(self, input_ch=3, num_classes=1000, pretrained=False):
        ...
        if input_ch != 3:
            resnet34_32s.conv1 = nn.Conv2d(input_ch, 64, kernel_size=7, stride=2, padding=3, bias=False)
            resnet34_32s.bn1 = nn.BatchNorm2d(64)
